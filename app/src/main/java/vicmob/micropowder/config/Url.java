...
public class Url {
    ...
    public final static String HOSTS = "http://120.78.222.131/";

    //http://www.vicmob.com/dapp/v_1.0.20/
    public final static String UpdateHOST = "http://www.vicmob.com/dapp/v_2.0.0/";
...
//    "http://www.vicmob.com/dapp/api.php?";
     ...
     * 获取添加的总的地点
     */
    public final static String   SELECT_ADD = HOSTS + "VicmobLazyEarnWeb/lazyearn-api/autoData/selectDevicesAddress";

    /**
     * 删除添加的总的地点
     */
    public final static String deleteAdd = HOSTS + "VicmobLazyEarnWeb/lazyearn-api/autoData/deleteAddress";
     ...
     * 城市运营商号段
     */
    public final static String CITY_NUMBER_DEViCES = HOSTS + "VicmobLazyEarnWeb/lazyearn-api/autoCity/earnSelectCityOperators";
    ...
    public final  static String getscidBinfo = HOSTS + "VicmobLazyEarnWeb/lz-api/lazyearn/lzUsescid/info";
